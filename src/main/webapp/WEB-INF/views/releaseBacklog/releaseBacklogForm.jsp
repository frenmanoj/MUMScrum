		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<form:input name="name" path="name"
					placeholder="Input Release Backlog  Name" class="form-control"
					required="true" />
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group date form_date1" data-date=""
					...
					<form:input id="startDate" class="form-control" path="startDate"
						type="text" />
			...
			<div class="form-group">
				...
				<div class="input-group date form_date2" data-date=""
					...
					<form:input id="endDate" class="form-control" type="text"
						path="endDate" />
					<span class="input-group-addon"><span
						class="glyphicon glyphicon-calendar"></span> </span>
				</div>
